...
VALUES 
('Sable','2024-06-08',30,NULL,200,'JJ','US',30,'USD','This is a test material',NOW(), NOW(),1,1),
('DM','2024-06-09',NULL,25,NULL,'MM','US',40,'EUR','This is a test material',NOW(), NOW(),1,1),
('SM','2024-06-08',NULL,1000,112,'KK','RU',3,'USD','This is a test material',NOW(), NOW(),1,1),
('BM','2024-06-08',NULL,750,135,NULL,'US',60,'EUR','This is a test material',NOW(), NOW(),1,1),
('Canady','2024-06-08',50,NULL,7,'XY','US',10,'USD','This is a test material',NOW(), NOW(),1,1);
...
INSERT INTO customer_banks (customer_id, raw_material_id, weight, units)
VALUES 
(@alon_id, @sable_id, 10, NULL),
(@avi_id, @sable_id, NULL, 15),
(@guy_id, @sable_id, 2, NULL),
(@eran_id, @sable_id, 16, NULL),
