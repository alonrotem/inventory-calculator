...
CREATE TABLE `babies` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_baby_raw_material_parent` (`raw_material_parent_id`),
  CONSTRAINT `fk_baby_raw_material_parent` FOREIGN KEY (`raw_material_parent_id`) REFERENCES `raw_materials` (`id`) ON DELETE CASCADE
...
CREATE TABLE `currencies` (
  ...
  `name` varchar(64) NOT NULL,
  `symbol` varchar(3) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `order` int DEFAULT (999),
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `raw_materials` (
  ...
  `purchased_at` date NOT NULL DEFAULT (curdate()),
  `weight` float DEFAULT NULL,
  `units` int DEFAULT NULL,
  `units_per_kg` float DEFAULT NULL,
  ...
  `updated_by` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_raw_material_country` (`origin_country`),
  KEY `fk_raw_material_currency` (`currency`),
  CONSTRAINT `fk_raw_material_country` FOREIGN KEY (`origin_country`) REFERENCES `countries` (`code`),
  CONSTRAINT `fk_raw_material_currency` FOREIGN KEY (`currency`) REFERENCES `currencies` (`code`)
...
--
-- Table structure for table `wing_positions`
--

DROP TABLE IF EXISTS `wing_positions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wing_positions` (
  `id` int NOT NULL,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `wing_positions` VALUES
(1,'Left'),
(2,'Top'),
(3,'Right'),
(4,'Crown');
...
--
-- Table structure for table `wings_babies`
--

DROP TABLE IF EXISTS `wings_babies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wings_babies` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `length` float NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_parent_wing_id` (`parent_wing_id`),
  CONSTRAINT `fk_parent_wing_id` FOREIGN KEY (`parent_wing_id`) REFERENCES `wings` (`id`) ON DELETE CASCADE
...
INSERT INTO `wings_babies` VALUES
(13,'Stone',1,4,8.5),
(15,'L1',1,1,5.5),
(16,'L2',1,1,6),
(17,'L3',1,1,7),
